...
class VisualizationEngine:
    ...
    def plot_training_curves(
        ...
        if "train" in metrics_history and "val" in metrics_history:
            ...
            axes[0, 0].plot(
                epochs, metrics_history["train"]["loss"], "b-", label="Training Loss"
            )
            axes[0, 0].plot(
                epochs, metrics_history["val"]["loss"], "r-", label="Validation Loss"
            )
            ...
            if "f1" in metrics_history["train"]:
                axes[1, 0].plot(
                    epochs, metrics_history["train"]["f1"], "b-", label="Training F1"
                )
                axes[1, 0].plot(
                    epochs, metrics_history["val"]["f1"], "r-", label="Validation F1"
                )
    ...
    def create_segmentation_overlay(
        self, image: torch.Tensor, mask: torch.Tensor, alpha: float = 0.5
    ) -> np.ndarray:
    ...
    def generate_comprehensive_report(
        ...
        save_name: str = "evaluation_report.html",
    ):
